export const htmlCode = (usertoken) => {
  return `
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom:10px;">
                              <tbody>
                                <tr align="center">
                                  ...
                                  <a class="buttonText" href= "http://localhost:3000/auth/verify-email?token=${usertoken}" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">Verify</a>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
...
// <a class="buttonText" href= "${req.protocol}://${req.headers.host}/auth/verify-email?token=${usertoken}" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">Verify</a>
